...
module.exports = {
        ...
        device
            .on('message', function (topic, payload, data) {
                ...
                if (message['type'] === 'intencoes') {
                    ...
                    helper.intencoes.patchByModuloIdAndUpdates(modulo_id, updates)
    ...
    equals: function (status, resp_status) {
        console.log(`${status.modulo_id} - ${resp_status.modulo_id}`)
        console.log(`${status.on_off} - ${resp_status.on_off}`)
        console.log(`${status.front_back} - ${resp_status.front_back}`)
        console.log(`${status.water} - ${resp_status.water}`)
        console.log(`${status.percent} - ${resp_status.percent}`)
        console.log(`${status.fail} - ${resp_status.fail}`)
